...
public class SupplierDAO {
    ...
    public void addFunction(SupplierDTO supplierDTO) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "un nouvelle fournisseur a ajouter avec succes.");
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public void editSupplierDAO(SupplierDTO supplierDTO) {
        try {
            ...
            prepStatement.executeUpdate();
            JOptionPane.showMessageDialog(null, "les information du fournisseur est modifier.");
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public void deleteSupplierDAO(String suppCode) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "le fournisseur est suprime.");
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public ResultSet getQueryResult(int Limit, int Offset) {
        try {
            String query = "SELECT suppliercode, fullname, location, mobile FROM suppliers LIMIT  "+Limit+ " OFFSET  " +Offset;
            resultSet = statement.executeQuery(query);
        } catch (Exception e) {
            e.printStackTrace();
        }
  ...
  // Supplier data set retrieval method
    public ResultSet getQueryResult2( ) {
        try {
    ...
    public DefaultComboBoxModel<String> setComboItems(ResultSet resultSet) throws SQLException {
        ...
        suppNames.add("Select un Fournisseur");
