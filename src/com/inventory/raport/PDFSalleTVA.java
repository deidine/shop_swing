...
public class PDFSalleTVA {
    ...
    public static void inBaoCao(File file, String date, String operationType, DefaultTableModel table, String customerInfo, String recu, String back, String total, boolean isTva, String bonCmnde) throws DocumentException, IOException, ParseException, URISyntaxException, InterruptedException {
        PdfSalle pdf = new PdfSalle();
        ...
        Paragraph nif = null;
        if (bonCmnde != null) {
            nif = new Paragraph("NIF : " + pdf.readTxtFile(4) + "       No Bon Commande : " + bonCmnde, fontChungNghieng);

        } else {
            nif = new Paragraph("NIF : " + pdf.readTxtFile(4) , fontChungNghieng);
        ...
        if (isTva) {
            double tvaCal = Double.parseDouble(total) / 1.6;
            unorderedList.add(new ListItem("MONTENT Sans TVA 16% : " + tvaCal, fontTenCuaHang));
        }
...
//        cel3.addElement(new Paragraph(  ""));
        ...
        cel2.setBorder(1);
        table.addCell(new Paragraph("TOTAL TTC"));
