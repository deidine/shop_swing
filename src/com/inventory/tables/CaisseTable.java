...
public class CaisseTable extends DefaultTableModel {
    ...
    public String[] getColums() {
        String[] COLUMNS = {
            "idCaisse", "Date",   "Total_payee",   "Vender_par" 
        };
        return COLUMNS;
    ...
    ResultSet getData() {
        ...
        ResultSet res = caisseDAO.getCaisseInfo();
    ...
    ResultSet getSearchData(String txt ) {
        ...
        ResultSet res = productDAO.getCaisseSearchInfo(txt);
        // ResultSetMetaData metaData = res.getMetaData();
        // int colCount = metaData.getColumnCount();
        return res;
    }
    ...
    ResultSet getSearchByDateData(String start,String end ) {
        ...
        ResultSet res = productDAO.getDateOfCaisseSearchInfo(start,end );
        // ResultSetMetaData metaData = res.getMetaData();
        // int colCount = metaData.getColumnCount();
        return res;
    }
