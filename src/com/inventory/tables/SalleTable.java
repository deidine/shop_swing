...
public class SalleTable extends DefaultTableModel {
    ...
    ResultSet getData(String isloan) {
        ...
        ResultSet res = productDAO.getSalesInfo(isloan);
    ...
    ResultSet getSearchData(String txt, String isLoan) {
        ...
        ResultSet res = productDAO.getSalesSearchInfo(txt, isLoan);
        // ResultSetMetaData metaData = res.getMetaData();
        // int colCount = metaData.getColumnCount();
        return res;
    }
    ...
    ResultSet getSearchByDateData(String start, String end, String isLoan) {
        ...
        ResultSet res = productDAO.getDateOfSalesSearchInfo(start, end, isLoan);
        // ResultSetMetaData metaData = res.getMetaData();
        // int colCount = metaData.getColumnCount();
        return res;
    }
